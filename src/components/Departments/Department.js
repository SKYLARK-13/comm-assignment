...
function Department() {
  ...
  return Object.keys(data.ceo.departments).map(function (key, item) {
    return (
      <React.Fragment key={key}>
        ...
        >
          ...
          <button style={buttonStyle} onClick={() => handleShowTeams(key)}>
            Show Team
          </button>
          <button style={buttonStyle} onClick={() => handleNewTeams(key)}>
            Add New Team
          </button>
          {showTeams == key && (
